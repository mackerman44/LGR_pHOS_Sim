...
```{r perc_good_CV, fig.height = 8, fig.cap = perc_good_cv}
...
```{r perc_good_cv_zoom_figure, fig.height = 8, fig.cap = perc_good_cv_zoom}
prop_trt_p +
...
```{r good_cv_det_figure, fig.height = 8, fig.cap = good_cv_det_fig}
...
```{r det_prob_figure, fig.height = 8, fig.cap = det_prob_fig}
