...
n_tags_sim = tibble(n_tags = seq(1, 300)) %>%
  mutate(cv = predict(n_tags_mod,
                      newdata = .,
                      type = 'response'))
# qplot(n_tags, cv, data = n_tags_sim)
