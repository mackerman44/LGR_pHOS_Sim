...
This assessment aims to determine the number or tagging rate of HOR adults at LGR necessary to determine *pHOS* across populations of spring/summer Chinook salmon and steelhead estimated by the DABOM model (supported by the operation of IPTDS supported by BPA project 2018-002-00), within "reasonable" statistical parameters (e.g., CV $\leq$ 15%).

*Previous comments by Lance (October 10, 2019) suggest this exercise should be limited to steelhead. Should we focus our analysis on steelhead, and then just use steelhead results to make inferences about Chinook salmon if desired? Perhaps this could be aided by keeping simulations to a theoretical species and populations. Or do we want to continue with Chinook salmon evaluations?*
...
Second, our goal is to determine what levels of additional tagging at LGR of adult HOR fish (H only) would allow resonable estimates of *pHOS*. We will define reasonable as an estimate with a CV of 15% or less. Our evaluation may (or may not) attempt to focus on desired or critical populations/locations.
